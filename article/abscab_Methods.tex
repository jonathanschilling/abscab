...
The corresponding normalized cylindrical coordinates~$(\rho', z')$ are given by
$\rho' = r \sin(\theta) / a$ and $z' = \sqrt{r^2 - \rho^2} / a$.
...
\begin{equation}
  ...
  = \frac{k^2}{\sqrt{z'^2 + (1 + \rho')^2}} \,\mathcal{C}(k_c)
\end{equation}
...
\begin{equation}
  \tilde{A}_{\varphi,\mathrm{v}} (\rho'=1, z') = \frac{1}{|z'|} \,\mathrm{cel}(k_c, 1, 1, -1)
\end{equation}
