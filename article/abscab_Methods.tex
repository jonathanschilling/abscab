...
\end{equation}
The domain decomposition used to compute $\tilde{A}_z$ accurately is depicted in Fig.~\ref{fig:sws_regions}(a).
...
\end{equation}
The domain decomposition used to compute $\tilde{B}_\varphi$ accurately is depicted in Fig.~\ref{fig:sws_regions}(b).
