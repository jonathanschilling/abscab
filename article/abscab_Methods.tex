...
\begin{equation}
  \tilde{A}_\mathrm{z,n} (\rho', z') = \frac{1}{2} \left[ \ln\left(n + 2 \right) - \ln \left( n \right)  \right] \label{eqn:sws_A_z_n}
\end{equation}
with
\begin{align}
  n                       =&\, a + b \\
  a \equiv r_\mathrm{i} - z'       =&\, 2 r_\mathrm{i} \sin^2(\alpha/2) \label{eqn:ri_zp} \\
  b \equiv r_\mathrm{f} - (1 - z') =&\, 2 r_\mathrm{f} \sin^2(\beta/2)  \label{eqn:rf_zp_1} \\
