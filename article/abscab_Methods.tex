...
\begin{equation}
  \tilde{B}_\varphi(\rho'=0, z') = \frac{1}{4} \left( \frac{1}{(1-z')^2} - \frac{1}{z'(1-z')} \right) \, .
\end{equation}
Similarly, a special case for~$z' \in \{0, 1\}$ can be derived:
\begin{equation}
  \tilde{B}_\varphi(\rho', z' \in \{0, 1\}) = \frac{1}{2 \rho' \sqrt{{\rho'}^2 + (1-z')^2}} \, .
\end{equation}
...
\begin{equation}
  ...
  = \frac{1}{2} \left(\frac{r_i}{r_f} + 1\right) \frac{1}{{\rho'}^2 + r_i r_f - z' (z' - 1)} \, .
\end{equation}
...
\end{equation}
with~$\alpha$ and~$\beta$ as introduced in the previous section.
%
