...
$A_\varphi$ of circular wire loop:
\begin{equation}
  \mathcal{C}(k_c)
  = \frac{2 \,\mathcal{D}(k_c) - \mathcal{K}(k_c)}{k^2}
  = \,\mathrm{cel} \left( \frac{2 \sqrt{k_c}}{1 + k_c}, 1, 0, \frac{2}{(1 + k_c)^3} \right) \, .
\end{equation}
In there:
\begin{equation}
  \mathcal{D}(k_c)
  = \frac{\mathcal{K}(k_c) - \,\mathcal{E}(k_c)}{k^2}
  = \,\mathrm{cel}(k_c, 1, 0, 1)
\end{equation}
and
\begin{align}
...
We also need Ref.~\cite{jahnke_emde} (Section V.B.11 on page 73 therein).
